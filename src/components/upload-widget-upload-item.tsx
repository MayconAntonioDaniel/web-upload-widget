...
import { DownloadIcon, ImageUp, Link2, RefreshCcw, X } from "lucide-react";
import { Button } from "./ui/button";
import { motion } from 'motion/react';
import { useUploads, type Upload } from '../store/uploads';
import { formatBytes } from '../utils/format-bytes';
import { downloadUrl } from '../utils/dowloand-url';
...
export function UploadWidgetUploadItem({
  ...
  return (
    <motion.div 
      ...
      className="p-3 rounded-lg flex flex-col gap-3 shadow-shape-content bg-white/3 relative overflow-hidden"
    >
      ...
      <div className="absolute top-2 right-2 flex items-center gap-1">
        ...
        <Button 
          disabled={ !['progress', 'canceled'].includes(upload.status) } 
          size="icon-sm"
